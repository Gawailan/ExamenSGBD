...
abstract class DAO implements DAOInterface {
    ...
    public function fetchNameFirstname ($name, $firstname) {
        $statement = $this->db->prepare("SELECT * FROM {$this->table} WHERE name_person = ? AND firstname_person = ?");
        try {
